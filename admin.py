...
print("""
###############################
#  Howert Admin Panel Finder  #
###############################
""")
print(Fore.BLUE)
site = input("Taranacak siteyi girin (Örnek: https://siteismi.com/  (Sonunda / olmalıdır))  >> ")
...
for ex in e:
    if ex.strip():
        ...
        if response.status_code == 200:
            print(Fore.GREEN + f"[+] Bulundu: {url}")
        else:
            print(Fore.RED + f"[-] Bulunamadı: {url}")
